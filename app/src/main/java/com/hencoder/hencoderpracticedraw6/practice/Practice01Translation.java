...
public class Practice01Translation extends RelativeLayout{
    ...
    protected void onAttachedToWindow(){
        ...
        animateBt.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(final View v){
                ...
                switch (clickTime) {
                    case 1:
                        imageView.animate().translationX(380);
                        break;
                    case 2:
     ...
     * 为音乐图标设置三角形的 Outline。
     */
    @RequiresApi(api=Build.VERSION_CODES.LOLLIPOP) class MusicOutlineProvider extends ViewOutlineProvider{
        Path path=new Path();
